...
const Footer = () => {
  return (
    <footer className="site-footer" id="contact">
      {" "}
      {/* id="contact" agar contact section yahi hai */}
      <div className="footer-animated-bg"></div>{" "}
      {/* New: For subtle animated background texture */}
      <div className="footer-content-wrapper">
        ...
        <div className="footer-main-content">
          ...
          >
            ...
            <p>
              Your ultimate portal to the infinite realms of anime. Discover,
              watch, and connect with a universe of stories and fans.
            </p>
          </div>
          <div
          ...
          >
            ...
            <ul>
              ...
              <li>
                <a href="/#universe">Universe Guide</a>
              </li>{" "}
              {/* Example link to a section on home page */}
              <li>
                <a href="/blog">Blog (Example)</a>
              </li>
              <li>
                <a href="/faq">FAQ</a>
              </li>
          ...
          <div
            className="footer-section legal-links"
            data-aos="fade-up"
            data-aos-delay="300"
          >
          ...
          <div
            className="footer-section connect"
            data-aos="fade-up"
            data-aos-delay="400"
          >
            ...
            <div className="social-icons">
              ...
              <a
                href="https://github.com/Gulshancr12"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="GitHub"
              >
              ...
              <a
                href="https://www.instagram.com/just_edits_._/"
                target="_blank"
                rel="noopener noreferrer"
              ...
              {/* YOUR INSTAGRAM LINK ADDED HERE */}
              <a
        ...
        <div className="footer-bottom">
          <p>
            © {new Date().getFullYear()} AnimePremi. All rights reserved.
            Crafted with <span className="heart-pulse">💖</span> for anime
            lovers.
          </p>
          <p>
            by{" "}
